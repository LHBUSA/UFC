...
$WorkerUrl = "https://propbetedge-ufc-api.sales-fd3.workers.dev"
...
try {
    ...
    Write-Host "===== UFC API: DEPLOY =====" -ForegroundColor Cyan
    npx wrangler deploy
    ...
    $Counts = Invoke-RestMethod -Method Get -Uri "$WorkerUrl/v1/ufc/counts"
