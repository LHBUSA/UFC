...
const SKIP_DIRS = new Set([
  ...
  'history', 'supabase', 'migrations', 'data', 'fixtures', 'shared', 'lib', 'sql', 'archive'
]);
// Files that ARE provenance / licence / citation surfaces: upstream names are required there.
const ALLOW = new Set([
  'web/app/about/page.tsx'  /* about our data: provenance */,
  'web/app/rankings/page.tsx'  /* official UFC rankings attribution */,
  'web/components/HowToWatchClient.tsx'  /* broadcast details verified against the official UFC listing */,
  'web/app/tuf/[slug]/page.tsx'  /* official TUF recap links / name corrections */,
  'web/app/learn/fight-dna/page.tsx'  /* methodology explainer */,
  'web/app/qa/preview/page.tsx'  /* internal QA fixture page (not customer-facing) */,
]);
...
const FORBIDDEN = [
  ...
  /\bUFC ?Stats\b/g, // UFC repo: the round-stat provider is PropSports in customer copy
