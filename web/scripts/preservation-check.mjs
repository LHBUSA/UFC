...
export const REQUIRED_ROUTES = ["/", "/events", "/events/[slug]", "/contender-series", "/fighters", "/fighters/[slug]", "/fights/[slug]", "/rankings", "/referees", "/referees/[slug]", "/judges", "/judges/[slug]", "/history", "/hall-of-fame", "/news", "/news/[slug]", "/voices/[key]", "/pro", "/fight-week", "/pregame/[slug]", "/learn/fight-dna", "/hall-of-fame/[slug]"];
...
if (args.has("--http")) {
  ...
  const http = [];
  const httpRoutes = ["/", "/fight-week", "/learn/fight-dna", "/events", "/contender-series", "/fighters", "/rankings", "/referees", "/judges", "/history", "/hall-of-fame", "/news", "/pro"];
