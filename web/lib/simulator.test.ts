...
import { simGate, methodRows, winView, pathView, roundOutcomeRows, roundRanges, gateReasons, anchorStrained, anchorCompare, resolvedRounds, ROUNDS_UNRESOLVED_COPY, MODEL_CARD, UNAVAILABLE_COPY } from "./simulatorView.ts";
