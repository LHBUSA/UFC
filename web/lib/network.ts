 ...
 *   - `discord` stays null until a permanent invite exists. Every invite in
 *     use across the network on 2026-09-11 (HPzYDAng, 8rMxrMG5, e9S6pFq9)
 *     returned "Unknown Invite"; a dead link is worse than no link.
