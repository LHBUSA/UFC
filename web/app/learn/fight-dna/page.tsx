...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", site: SITE.twitter, title: "Fight DNA: Advanced MMA Analytics, Fighter Profiles & Matchup Intelligence", description: DESCRIPTION, images: [`${SITE.url}/opengraph-image`] },
};
