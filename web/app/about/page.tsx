  ...
  return (
    <div className="wrap page narrow">
      ...
      <div className="prose">
        ...
        <p>Every photograph we host is a Creative Commons or public-domain image from Wikimedia Commons: fighter portraits (matched to the fighter through Wikidata), referee portraits, story images and the site's background textures. Each is copied to our own storage with its author, licence and source page, and is shown only when its stored licence permits commercial use. The credit line (author, licence and a link to the source) appears on fighter profiles, fight pages and story pages; small thumbnails on cards and lists do not repeat it.</p>
        <p>Where no such photograph exists, we show the fighter's initials instead. We do not fill the gap with a photo from another site, and we do not use UFC, Zuffa, Getty, ESPN or Sherdog photographs. Official video is the one exception to self-hosting: it plays in YouTube's player from the publisher's own channel, and its poster frame is served by YouTube. We never generate a real fighter's likeness with AI.</p>
