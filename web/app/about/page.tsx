  ...
  return (
    <div className="wrap page narrow">
      ...
      <div className="prose">
        ...
        <p>Fighter portraits are Creative Commons or public-domain photographs from Wikimedia Commons, matched to the fighter through Wikidata, stored with the author, licence and source, and credited wherever they appear. We do not use UFC, Zuffa, Getty, ESPN or Sherdog photographs as fighter portraits, and we do not fill gaps with another site&apos;s headshots: where no licensed portrait exists we show a branded placeholder. Official fight videos are embedded from the publisher&apos;s own YouTube channel, and their preview image is the thumbnail YouTube provides for that video. We never generate a real fighter&apos;s likeness with AI.</p>
