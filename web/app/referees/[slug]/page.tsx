...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return { title, description, alternates: { canonical: `/referees/${r.slug}` }, openGraph: { title, description, url: `${SITE.url}/referees/${r.slug}`, images: [`${SITE.url}/opengraph-image`] }, twitter: { card: "summary_large_image", site: SITE.twitter, title, description, images: [`${SITE.url}/opengraph-image`] } };
}
